...
turtle.Image = 'rbxassetid://131187893113741'
turtle.Rotation = 15
...
L_1_[15].Text = 'DeltaK Hub - Kaitun'
...
task.spawn(function()
    while task.wait() do
        ...
        local L_NEW_TWEEN = L_1_[6]:Create(L_NEW_STROKE, TweenInfo.new(1.2), {
            Color = Color3.fromRGB(255, 165, 0),
        })
        local L_NEW_TEXT_TWEEN = L_1_[6]:Create(L_NEW_TEXT, TweenInfo.new(1.2), {
            TextColor3 = Color3.fromRGB(255, 165, 0),
        })
